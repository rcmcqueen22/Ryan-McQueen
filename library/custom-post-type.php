...
function custom_post_example() { 
	...
	register_post_type( 'web', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		// let's now add all the options for this post type
		array( 'labels' => array(
			'name' => __( 'Web Projects', 'bonestheme' ), /* This is the Title of the Group */
			'singular_name' => __( 'Web Projects', 'bonestheme' ), /* This is the individual type */
			'all_items' => __( 'All Web Projects', 'bonestheme' ), /* the all items menu item */
			'add_new' => __( 'Add New', 'bonestheme' ), /* The add new menu item */
			'add_new_item' => __( 'Add New Web Project', 'bonestheme' ), /* Add New Display Title */
			'edit' => __( 'Edit', 'bonestheme' ), /* Edit Dialog */
			'edit_item' => __( 'Edit Web Project', 'bonestheme' ), /* Edit Display Title */
			'new_item' => __( 'New Web Project', 'bonestheme' ), /* New Display Title */
			'view_item' => __( 'View Web Project', 'bonestheme' ), /* View Display Title */
			'search_items' => __( 'Search Web Projects', 'bonestheme' ), /* Search Custom Type Title */ 
			'not_found' =>  __( 'Nothing found in the Database.', 'bonestheme' ), /* This displays if there are no entries yet */ 
			'not_found_in_trash' => __( 'Nothing found in Trash', 'bonestheme' ), /* This displays if there is nothing in the trash */
			'parent_item_colon' => ''
			), /* end of arrays */
			'description' => __( 'This is the Web Projects Post Type', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
			...
			'rewrite'	=> array( 'slug' => 'web', 'with_front' => false ), /* you can specify its url slug */
			'has_archive' => 'web', /* you can rename the slug here */
	...
	*/
	...
	//register_taxonomy( 'custom_cat', 
		...
		//array('hierarchical' => true,     /* if this is true, it acts like categories */
			//'labels' => array(
				//'name' => __( 'Work Categories', 'bonestheme' ), /* name of the custom taxonomy */
